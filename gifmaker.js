...
function _makeForest(filename){
    ...
    var forestOptions = {
        ...
        NUM_TREES: Math.floor(30 + Math.random()*20),
        //NUM_TREES: 5,
    ...
    var maxDepth = _r.randomInt(7,10);
    var topColor = _c.randomHex();
    var treeOptions = {
        BRANCH_R_MAX: branchMaxRad,
        BRANCH_R_MIN: 0.06,
        BRANCH_L: branchMaxRad*_r.random(5,9),
        ...
        RAINBOW: false,
        COLOR_TOP: topColor, 
        COLOR_BTM: _c.brightenByAmt(topColor,-100), 
        ...
        LEAF_W: _r.random(0.7,2),
        MAX_DEPTH: maxDepth, 
        // MAX_BRANCHES_TOTAL: 999, 
        MAX_BRANCHES_PER_NODE:  maxDepth < 9 ? 3 : 2
    };
